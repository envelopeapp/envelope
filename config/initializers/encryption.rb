# This file loads up the encryption key and stores it in a constant that is accessible
# to the entire application. This is so we can encrypt and securely store IMAP logins.
